			...
			<nav class="navbar yamm navbar-default">
				<div class="navbar-header">
                    <button type="button" data-toggle="collapse" data-target="#navbar-collapse-1" class="navbar-toggle">
                        ...
                        <span class="icon-bar"></span>
                                    ...
                                    <a href="index.php" class="navbar-brand"><img src="logo/ekg1.gif" alt="" class="img img-responsive" style="height: 60px; width: 150px;"></a>
				...
				<div id="navbar-collapse-1" class="navbar-collapse collapse navbar-right">
					<ul class="nav navbar-nav">
                                            ...
                                            <li><a href="symptom.php">Check with Symptoms</a></li>
                ...
                <ul>
					<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        ...
                        <div class="tp-caption customin customout"
                            ...
                            style="z-index: 3"><img src="web_style/demos/gallery_04.jpg" alt="">
                        </div>
                    </li>
					<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
        	...
        	<div class="general-row">
                <div class="custom-services">
                    <div class="col-lg-12 col-md-12"><br />
                        <h3>Hospitals With US</h3>
                        <?php
                        $sel_hos=mysqli_query($dbcon,"select * from usr_log,org_data where org_data.unme=usr_log.uid and usr_log.typ='1'");
                        if(mysqli_num_rows($sel_hos)>0)
                        {
                            while($r_hos=  mysqli_fetch_row($sel_hos))
                            {
                                ?>
                        
                            <?php
                            $sel_abt=mysqli_query($dbcon,"select * from abt_hospital where h_id='$r_hos[7]'");
                            if(mysqli_num_rows($sel_abt)>0)
                            {
                                $r_abt=mysqli_fetch_row($sel_abt);
                                ?>
                        <div class="col-lg-4 col-md-4">
                            <img src="hospital/pic/<?php echo $r_abt[3] ?>" class="img img-responsive" style="height: 200px;" />
                            <center><h6><?php echo $r_hos[6] ?></h6></center>
                        </div>
                        <?php
                            }
                            else
				...
				<div class="custom_tab_2 row">
                    <div class="col-md-3">
                        <ul class="nav nav-pills nav-stacked" id="another_tab">
                            <?php
                            $sel_dep=mysqli_query($dbcon,"select * from department_data");
                            $i=0;
    ...
    <div class="grey-wrapper">
    	<div class="container">
            <div class="col-lg-12" style="display:none;">
                ...
                <div class="col-lg-8">
                    <h3>Medical Treatment Helper</h3>
                    <select name="ds" class="form-control" onchange="load_data(this.value)">
                        <option>Choose</option>
                        <?php
                            $sel_d=mysqli_query($dbcon,"SELECT * FROM `disease_data` ORDER BY `deseas` ASC");
                            if(mysqli_num_rows($sel_d)>0)
                            {
                                while($r_d=mysqli_fetch_row($sel_d))
                                {
                                    ?>
                                    <option value="<?php echo $r_d[2] ?>"><?php echo $r_d[2] ?></option>
                                    <?php
                                }
                            }
                            ?>
                ...
                function load_data(x)
                {
                    ...
                    xmlhttp.open("GET", "get_data.php?d=" + x, true);
                    xmlhttp.send();
                }
                </script>
                <div class="col-lg-2"></div>
