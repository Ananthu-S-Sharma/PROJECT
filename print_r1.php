...
$aid=$_GET['aid'];
$sel_data=mysqli_query($dbcon,"select * from new_patient where id='$aid'");
$r_data=mysqli_fetch_row($sel_data);
$sel_cit=mysqli_query($dbcon,"select * from cit_data where bar_code='$r_data[2]'");
$r_cit=mysqli_fetch_row($sel_cit);
$sel_doc=mysqli_query($dbcon,"select * from doc_data where em='$r_data[10]'");
$r_doc=mysqli_fetch_row($sel_doc);
?>
<!DOCTYPE html>
<!--
