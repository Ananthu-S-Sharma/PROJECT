...
<html>
    ...
    <body>       
        <?php
       $sel=mysqli_query($dbcon,"select * from org_data where stat='$s' and dis='$d' and st=1");
       if(mysqli_num_rows($sel)>0)
       {
        ...
        <div class="col-lg-4">
            ...
            <?php
            $sel_hos=mysqli_query($dbcon,"select * from org_data where stat='$s' and dis='$d' and org_typ='1' and st=1");
        ...
        <div class="col-lg-4">
            ...
            <?php
            $sel_hos=mysqli_query($dbcon,"select * from org_data where stat='$s' and dis='$d' and org_typ='3' and st=1");
            if(mysqli_num_rows($sel_hos)>0)
            {
                ?><br /><br />
            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
        ...
        <div class="col-lg-4">
            ...
            <?php
            $sel_hos=mysqli_query($dbcon,"select * from org_data where stat='$s' and dis='$d' and org_typ='2' and st=1");
            if(mysqli_num_rows($sel_hos)>0)
            {
                ?><br /><br />
            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
