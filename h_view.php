...
ob_start();
$hid=$_GET['hid'];
$sel_aut=mysqli_query($dbcon,"select * from org_data where unme='$hid'");
$r_aut=mysqli_fetch_row($sel_aut);
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="custom-services">
                    <div class="col-lg-12 col-md-12"><br />
                        <h3><?php echo $r_aut[1] ?></h3>
                         <?php
                            $sel_abt=mysqli_query($dbcon,"select * from abt_hospital where h_id='$hid'");
                    ...
                    <div class="col-md-3">
                        <ul class="nav nav-pills nav-stacked" id="another_tab">
                            <?php
                            $sel_dep=mysqli_query($dbcon,"select * from department_data,hos_dep where department_data.id=hos_dep.dep_id and hos_dep.h_id='$hid'");
                            $i=0;
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane <?php echo $cls ?>" id="tabbed_<?php echo $i ?>">                            	
                                ...
                                <h4>Our Experts</h4>
                                <?php
                                $sel_doc=mysqli_query($dbcon,"select * from doc_data where h_id='$hid' and dep='$r_dep[0]'");
